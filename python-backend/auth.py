...
# Load demo users only in development and test environments
ENVIRONMENT = os.getenv("ENVIRONMENT", "development")

if ENVIRONMENT in ("development", "test"):
    # Import demo users for development and testing
    from demo_users import DEMO_USERS_DB
    fake_users_db = DEMO_USERS_DB
    logger.info(f"Loaded demo users for {ENVIRONMENT} environment")
else:
    # Empty user database in production - must be replaced with real database
    fake_users_db = {}
    logger.warning("Demo users disabled in production. Configure real user database.")
