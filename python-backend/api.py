...
async def chat_endpoint(
    ...
    current_user: Optional[User] = Depends(
        get_current_active_user if Config.REQUIRE_AUTH else get_optional_current_user
    )
):
    """
    ...
    **Authentication:**
    ...
    - REQUIRE_AUTH=true: Authentication required (production default)
    - REQUIRE_AUTH=false: Authentication optional (development default)
