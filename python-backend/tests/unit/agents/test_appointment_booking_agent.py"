...
from main import appointment_booking_agent, appointment_booking_instructions, BuildingProjectContext
...
class TestAppointmentBookingAgent:
    ...
    async def test_appointment_booking_agent_configuration(self):
        ...
        assert len(appointment_booking_agent.tools) == 2  # check_specialist_availability, book_consultation
        assert len(appointment_booking_agent.input_guardrails) == 2  # relevance and jailbreak
        assert appointment_booking_agent.model == "gpt-4o-mini"
    ...
    @pytest.mark.asyncio
    @pytest.mark.agents
    async def test_appointment_booking_instructions_with_inquiry_id(self, mock_context_wrapper):
        """Test appointment booking instructions include inquiry ID."""
        instructions = appointment_booking_instructions(mock_context_wrapper, appointment_booking_agent)
    ...
    @pytest.mark.asyncio
    @pytest.mark.agents
    async def test_appointment_booking_instructions_consultation_status(self, mock_context_wrapper):
    ...
    @pytest.mark.asyncio
    @pytest.mark.agents
    async def test_appointment_booking_instructions_procedure(self, mock_context_wrapper):
    ...
    @pytest.mark.asyncio
    @pytest.mark.agents
    async def test_appointment_booking_instructions_specialist_types(self, mock_context_wrapper):
    ...
    @pytest.mark.asyncio
    @pytest.mark.agents
    async def test_appointment_booking_instructions_contact_info(self, mock_context_wrapper):
    ...
    @pytest.mark.asyncio
    @pytest.mark.agents
    async def test_appointment_booking_instructions_location(self, mock_context_wrapper):
    ...
    @pytest.mark.asyncio
    @pytest.mark.agents
    async def test_appointment_booking_instructions_handoff_guidance(self, mock_context_wrapper):
    ...
    async def test_appointment_booking_agent_execution(self, mock_runner, mock_context_wrapper):
        ...
        result = await mock_runner(appointment_booking_agent, input_text, context=mock_context_wrapper.context)
    ...
    @pytest.mark.asyncio
    @pytest.mark.agents
    async def test_appointment_booking_instructions_step_by_step(self, mock_context_wrapper):
    ...
    @pytest.mark.asyncio
    @pytest.mark.agents
    async def test_appointment_booking_instructions_confirmation_process(self, mock_context_wrapper):
    ...
    async def test_appointment_booking_instructions_dynamic_context(self):
        ...
        for context in test_contexts:
            ...
            instructions = appointment_booking_instructions(wrapper, appointment_booking_agent)
            assert isinstance(instructions, str)
    ...
    @pytest.mark.asyncio
    @pytest.mark.agents
    async def test_appointment_booking_agent_professional_tone(self, mock_context_wrapper):
    ...
    @pytest.mark.asyncio
    @pytest.mark.agents
    async def test_appointment_booking_agent_data_collection(self, mock_context_wrapper):
    ...
    @pytest.mark.asyncio
    @pytest.mark.agents
    async def test_appointment_booking_agent_availability_checking(self, mock_context_wrapper):
